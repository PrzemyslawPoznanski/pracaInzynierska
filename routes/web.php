...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Task Progress
    Route::delete('task-progresss/destroy', 'TaskProgressController@massDestroy')->name('task-progresss.massDestroy');
    Route::resource('task-progresss', 'TaskProgressController');
