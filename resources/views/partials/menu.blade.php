        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('task_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/task-statuses*") ? "menu-open" : "" }} {{ request()->is("admin/task-tags*") ? "menu-open" : "" }} {{ request()->is("admin/tasks*") ? "menu-open" : "" }} {{ request()->is("admin/tasks-calendars*") ? "menu-open" : "" }} {{ request()->is("admin/task-progresss*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/task-statuses*") ? "active" : "" }} {{ request()->is("admin/task-tags*") ? "active" : "" }} {{ request()->is("admin/tasks*") ? "active" : "" }} {{ request()->is("admin/tasks-calendars*") ? "active" : "" }} {{ request()->is("admin/task-progresss*") ? "active" : "" }}" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('task_progress_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.task-progresss.index") }}" class="nav-link {{ request()->is("admin/task-progresss") || request()->is("admin/task-progresss/*") ? "active" : "" }}">
